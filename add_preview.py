#!/usr/bin/env python3
"""Insert screensaver preview image into xmatrix.sav at code offset 256."""
...
XMATRIX_SAV = os.path.join(os.path.dirname(__file__), 'xmatrix.sav')
